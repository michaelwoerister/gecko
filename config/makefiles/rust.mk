...
ifdef MOZ_PGO_RUST
rust_pgo_flags := -Zdisable-instrumentation-preinliner $(if $(MOZ_PROFILE_GENERATE),-C profile-generate=$(topobjdir)) $(if $(MOZ_PROFILE_USE),-C profile-use=$(topobjdir)/merged.profdata)
endif
